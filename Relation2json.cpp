...
double normalizedCost(long io, long space, long base_io, long base_space) {
	float res;
...
void ForestCost (Forest* f, vector<Query*>* q, vector<float>* w, Graph* g) {
    //space_cost
...
vector<Forest*> Relational2JSON(Graph* g, vector<Query*>* q, vector<float>* w) {
